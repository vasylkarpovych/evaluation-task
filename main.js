...
4. Алгоритм будет по каждой из трех осей, мы вычитаем значение distance[x] = r[x] - a[x] 
5. к примеру: хR=10 х2User=50 ... хDistance=10-50=-40
              хR=40 хUser=10 ... хDistance=40-10=30
...
Я принял решение, что мы дистанцию делим на два и повторям в цикле, когда координаты первой и второй точки равны, то мы нашли искомую точку
х1=8 х2=9 ... 8-9=-1=1
остаток от деления мы каждый раз округляем. 
...
Вопроы:
- даже в моем исполнении, чего у меня в самых вложенных функциях нажимаются кнопки, я ж не делал внутри обработчик onClick
